...
/** Name: Sharon
  ...
  * Assignment: Employee class of Assignment 5
  * 
...
public class Employee
{
  ...
  //mutator: passes hourlyWage value from PayrollApp
  public void setWorkedHours(int newWorkedHours) throws IllegalArgumentException
  {
    //throw exception: the number of hours worked must be greater than 0
    if(newWorkedHours <=0)
    {
      throw new IllegalArgumentException("Number of hours worked must be greater than 0"); 
    }
